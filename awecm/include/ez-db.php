<?php
	...
	/**********************************************************************
	*  Author: Justin Vincent (justin@visunet.ie) (Portions by SR)
	*  Web...: http://php.justinvincent.com
	*  Name..: ezdb
	*  Desc..: ezdb - mySQL database abstraction library to make
	*          it very easy to deal with mySQL databases.
	*
	*/


	/****************************************************
	*		Portions modified by SR info@arroWebs.com
	*
	*		Merged the mysql and core classes to make it into one file - easy portability
	*		introduced the $charset to handle improper mySQL installations
	*		DB_CHARSET must be defined as in Wordpress 2.5
	*/
	...
	*/
	...
	class ezdb
	{
		...
		*/
		...
		function ezdb($dbuser='', $dbpassword='', $dbname='', $dbhost='localhost')
		{
			$this->dbuser = $dbuser;
		...
		*/
		...
		function debug()
		{
			...
			echo "</blockquote></blockquote>"; // haha no fun! .$this->donation()."<hr noshade color=dddddd size=1>";
