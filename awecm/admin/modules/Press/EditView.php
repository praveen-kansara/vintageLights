...
if(!empty($_REQUEST['id'])) {
  ...
  $link = $site_url.$press_path."<span data-slug='".$focus->slug."'>".$focus->slug."/</span>";
  $redirect_link = $site_url.$press_path.$focus->slug."/";


  $xtpl->assign('ID',                     $focus->id);
  $xtpl->assign('PRESS_TITLE',             $focus->title);
  ...
  $xtpl->assign('PRESS_CONTENT',           $focus->content);
  $xtpl->assign('PRESS_SHORT_DESCRIPTION', $focus->short_description);
  ...
  $xtpl->assign('INLINE_SCRIPTS',   isset($page_meta_array['inline_scripts'])   ? $page_meta_array['inline_scripts'] : "");
