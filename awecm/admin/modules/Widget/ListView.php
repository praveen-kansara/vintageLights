...
$xtpl= new XTemplate("modules/Widget/ListView.html");
...
if($response['list']) {
  ...
  foreach($response['list'] as $seed) {
    ...
    $row['SHORT_CODE'] = isset($page_meta_array['short_code']) ? $page_meta_array['short_code'] : "";
...
$xtpl->assign("SEQUENCE_ORDER_BY",   make_order_by("sequence",      'Sequence'));
...
require_once("modules/Widget/Search.php");
