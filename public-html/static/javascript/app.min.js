...
$(document).ready(function() {
   $('.sidebar-toggle').click(function() {
     ...
     if (Boolean(localStorage.getItem("sidebar-toggle-collapsed"))) {
       ...
       document.cookie = "sidebar_toggle_collapsed=false; expires=Thu, 18 Dec 2099 12:00:00 UTC;"
     } 
     else {
       localStorage.setItem("sidebar-toggle-collapsed", "1");
       document.cookie = "sidebar_toggle_collapsed=true; expires=Thu, 18 Dec 2099 12:00:00 UTC;";
     }
